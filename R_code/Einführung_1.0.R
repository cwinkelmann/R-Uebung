...
## Konfidenzinterval
## Üben, um die Frage zu beantworten: Wie kann ich die Wachstumsrate zwischen Behandlungen vergleichen??
...
## Übung: Versuchen Sie, Partitionierung von Variante "W50" als Datensatz "DataW50" zu berechnen
